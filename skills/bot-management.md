...
Replace `<APP_URL>` with the actual mini-app URL. Inside agent code that's `${baseUrl}/app/${projectId}/`. From within `routes.js` you can hardcode it or pass it through a config DB key set during build.
