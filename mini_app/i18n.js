...
const I18N = {
  en: {
    ...
    pref_game_fee_label: "+{amount} cr",
    pref_game_fee_hint: "Game kind costs {amount} credits, charged once.",
    pref_game_insufficient_funds: "Game kind costs {required} credits. Your balance: {balance} cr. Top up to continue.",
  ...
  ru: {
    ...
    pref_game_fee_label: "+{amount} кр",
    pref_game_fee_hint: "Тип «Игра» стоит {amount} кредитов — списывается один раз.",
    pref_game_insufficient_funds: "Тип «Игра» стоит {required} кредитов. Ваш баланс: {balance} кр. Пополните счёт.",
  ...
  ua: {
    ...
    pref_game_fee_label: "+{amount} кр",
    pref_game_fee_hint: "Тип «Гра» коштує {amount} кредитів — списується одноразово.",
    pref_game_insufficient_funds: "Тип «Гра» коштує {required} кредитів. Ваш баланс: {balance} кр. Поповніть рахунок.",
