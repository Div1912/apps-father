...
4. Make the edit in `frontend/index.html`. Do NOT create `frontend/app.js`, `frontend/styles.css`, or `backend/routes.js` unless the user explicitly asks for server-side multiplayer/shared persistence.
