...
- Use `npm_install` to declare runtime dependencies (allowlisted packages only — not `shell("npm install ...")`). Use `shell` for non-package-manager commands: small node scripts, curl, sanity tests.
