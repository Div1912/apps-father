...
8. Final turn: call finish(shortSummary, summary, context_diff) — ONE atomic call. Do NOT call configure_app during updates. See finish-tool.md for the third arg.
